/**
 * SFX for Constant Transition / Space Optimization reel.
 */
(function(global) {
  'use strict';

  var STORAGE_KEY = 'ctoReelSoundEnabled';
  var ctx = null;
  var masterGain = null;
  var enabled = true;
  var lastTs = 0;
  ...
  function tablePeek() { blip(420, 0.04, 0.07, 'triangle'); }
  function tableFill(isBase) { blip(isBase ? 520 : 640, 0.045, 0.085, 'sine'); }
  function varPeek() { blip(380, 0.038, 0.065, 'triangle'); }
  function varShift() { blip(720, 0.05, 0.09, 'sine'); }
